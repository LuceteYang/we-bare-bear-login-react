...
const WhiteBear = () => {
    return (
        <svg id="bear" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
            ...
            <g className="ears">
                <path d="M44,32 L44,30 C44,16 24,16 24,30 L24,32" fill="#fff" stroke="#000" strokeWidth="2.5" strokeLinecap="round" transform="rotate(-10,38,24)" />
                <path d="M75,32 L75,30 C75,16 95,16 95,30 L95,32" fill="#fff" stroke="#000" strokeWidth="2.5" strokeLinecap="round" transform="rotate(10,82,24)" />
            </g>
